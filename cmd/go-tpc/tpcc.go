...
func registerTpcc(root *cobra.Command) {
	...
	cmdRun.PersistentFlags().BoolVar(&tpccConfig.Debug, "debug", false, "print a line to stderr when a transaction is rolled back due to a transient conflict (deadlock/serialization failure)")
